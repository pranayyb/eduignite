...
with open("sci_2.txt", "r", encoding="utf-8") as file2:
    lecture = file2.read()


def generate_mimic_response(question, lecture_stats, lecture):
    system_prompt = f"""
    ...
    **Pacing: {lecture_stats['pac']}
    ...
    ## Below is the lesson taught during the lecture
    {lecture}
...
response = generate_mimic_response(question, data, lecture)
print(response)
